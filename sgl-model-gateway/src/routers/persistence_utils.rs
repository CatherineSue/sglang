//! Response and conversation item persistence utilities.
//!
//! This module provides shared functionality for persisting responses
//! and conversation items to storage, used across different router
//! implementations (OpenAI, gRPC).
...
/// Convert a ConversationItem to JSON representation
