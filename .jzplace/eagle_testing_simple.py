...
# The draft model is fine-tuned with chat template. When it is applied, the draft and target model will predict more consistent results
prompts = {
    "joke": "Tell me a long joke in 1000 words",
    "code": "Give me a simple FastAPI server. Show the python code.",
    "fact": "Tell me about Seattle in 1000 words",
